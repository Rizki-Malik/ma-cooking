            ...
            <div className="list">
                <div className="list-item-l">
                    ...
                    <div className="info-course-l">
                        <h1 className="title text-4xl font-bold">Barbecue</h1>
                        <h3 className="period text-xl font-semibold">A 6-week online course</h3>
                ...
                <div className="list-item-r">
                    <div className="info-course-r">
                        <h1 className="title text-4xl font-bold">Pastery Cake</h1>
                        <h3 className="period text-xl font-semibold">A 4-week online course</h3>
